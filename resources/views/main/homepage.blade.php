...
<div id="content" class="rst-main-content rst-content-full">
    ...
    <div class="container">
        ...
        <form class="rst-form-input rst-book" action="http://themeforces.com/">
            <div class="row">
                <div class="col-sm-3">
    ...
    <div class="rst-newsletter">
        <strong><span>Subscribe to our newsletter</span></strong>
        <form action="http://themeforces.com/"><input type="text" placeholder="Your Email" class="has-success" value=""></form>
    </div><!--- end Newsletter -->
