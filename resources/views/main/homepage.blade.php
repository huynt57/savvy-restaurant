                            ...
                            <div class="rst-table">
                                <div class="rst-table-row">
                                    <div class="rst-table-cell" style="width: 50%">
                                        ...
                                        <a class="btn btn-lg btn-danger" href="<?php echo url('menu')?>">Browse menu</a>
...
<div id="content" class="rst-main-content rst-content-full">
            ...
            <div class="rst-table">
                <div class="rst-table-row">
                    ...
                    <div class="rst-dishes-content rst-table-cell">
                        ...
                        <a href="<?php echo url('menu')?>" class="btn btn-lg btn-success">Browse menu</a>
    ...
    <div class="rst-visitors" data-background="img/post/bg_visitors.jpg">
        <div class="container">
            ...
            <div class="text-center">
                <a class="btn btn-lg btn-success" href="<?php echo url('menu')?>">Browse menu</a>
                <a class="rst-down while" href="#"><i class="fa fa-chevron-down"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="rst-newsletter black">
        ...
        <form action="http://themeforces.com/"><input type="text" value="" class="has-success" placeholder="Your Email" /></form>
    </div>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <a href="<?php echo url('menu')?>" class="btn btn-lg btn-danger">Browse menu</a>
            <a href="#" class="rst-down"><i class="fa fa-chevron-down"></i></a>
        </div>
    </div>
