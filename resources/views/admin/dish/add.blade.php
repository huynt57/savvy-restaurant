<div id="modal-add" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">

    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="modal-label">Add new dish</h3>
    </div>
    <form action="<?php echo url('admin/dish/add') ?>" method="POST" class="form-horizontal" enctype="multipart/form-data" id="form-add" role="form">
